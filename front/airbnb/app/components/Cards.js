        ...
        renderItem={({ item }) => (
          <View>
            <View style={{ marginVertical: 15 }}>
              ...
              <Typography.P color={colors}>{item.detail}</Typography.P>
            </View>
            <HLine />
          </View>
        )}
          ...
          <View style={{flexDirection:"row", alignItems:'center', justifyContent:'flex-end'}}>
            ...
            {rooms && (
              <View style={{flexDirection:'row',alignItems:'center', marginTop:-16}}>
                  <FontAwesome5 name="bed" color={colors.blue} size={10} style={{marginRight: 4}} />
                  <Typography.P color={colors.blue} numberOfLines={1}>
                    {rooms}
                  </Typography.P>
                </View>
              )}
                <View style={{flexDirection:'row',alignItems:'center'}}>
                  <FontAwesome5 name="coins" color={colors.blue} size={10} style={{marginRight: 2}} />
                  <Typography.P color={colors.blue} numberOfLines={1}>
                    {secondary}€
                  </Typography.P>
                </View>
